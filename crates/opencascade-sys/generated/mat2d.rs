...
impl Circuit {
    ...
    pub fn as_standard_transient_mut(&mut self) -> &mut crate::standard::Transient {
        unsafe { &mut *(crate::ffi::MAT2d_Circuit_as_Standard_Transient_mut(self as *mut Self)) }
    }
    ...
    pub fn is_instance(&self, theType: &crate::ffi::HandleStandardType) -> bool {
        unsafe { crate::ffi::MAT2d_Circuit_inherited_IsInstance(self as *const Self, theType) }
    }
    ...
    pub fn this(&self) -> Option<&crate::standard::Transient> {
        {
            let ptr = unsafe { crate::ffi::MAT2d_Circuit_inherited_This(self as *const Self) };
            if ptr.is_null() {
                None
            } else {
                Some(unsafe { &*ptr })
    ...
    pub fn decrement_ref_counter(&mut self) -> i32 {
        unsafe { crate::ffi::MAT2d_Circuit_inherited_DecrementRefCounter(self as *mut Self) }
    }
...
impl HandleMAT2dCircuit {
    ...
    pub fn to_handle_transient(&self) -> crate::OwnedPtr<crate::ffi::HandleStandardTransient> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::HandleMAT2dCircuit_to_HandleStandardTransient(
                self as *const Self,
            ))
        }
    }
...
impl Connexion {
    ...
    /// Upcast to Standard_Transient (mutable)
    pub fn as_standard_transient_mut(&mut self) -> &mut crate::standard::Transient {
        unsafe { &mut *(crate::ffi::MAT2d_Connexion_as_Standard_Transient_mut(self as *mut Self)) }
    }
    ...
    /// Inherited: **Source:** `Standard_Transient.hxx`:75 - `Standard_Transient::IsInstance()`
    pub fn is_instance(&self, theType: &crate::ffi::HandleStandardType) -> bool {
        unsafe { crate::ffi::MAT2d_Connexion_inherited_IsInstance(self as *const Self, theType) }
    }

    /// Inherited: **Source:** `Standard_Transient.hxx`:83 - `Standard_Transient::IsKind()`
    pub fn is_kind(&self, theType: &crate::ffi::HandleStandardType) -> bool {
        unsafe { crate::ffi::MAT2d_Connexion_inherited_IsKind(self as *const Self, theType) }
    }

    /// Inherited: **Source:** `Standard_Transient.hxx`:94 - `Standard_Transient::This()`
    pub fn this(&self) -> Option<&crate::standard::Transient> {
        {
            let ptr = unsafe { crate::ffi::MAT2d_Connexion_inherited_This(self as *const Self) };
            if ptr.is_null() {
                None
            } else {
                Some(unsafe { &*ptr })
    ...
    /// Inherited: **Source:** `Standard_Transient.hxx`:107 - `Standard_Transient::DecrementRefCounter()`
    pub fn decrement_ref_counter(&mut self) -> i32 {
        unsafe { crate::ffi::MAT2d_Connexion_inherited_DecrementRefCounter(self as *mut Self) }
    }
...
impl HandleMAT2dConnexion {
    ...
    pub fn to_handle_transient(&self) -> crate::OwnedPtr<crate::ffi::HandleStandardTransient> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::HandleMAT2dConnexion_to_HandleStandardTransient(
                self as *const Self,
            ))
        }
    }
