...
pub fn write_shape_charptr_int(
    ...
    unsafe { crate::ffi::VrmlAPI_write_shape_charptr_int(aShape, c_aFileName.as_ptr(), aVersion) }
}
...
impl CafReader {
    ...
    pub fn new() -> crate::OwnedPtr<Self> {
        unsafe { crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_CafReader_ctor()) }
    }
    ...
    pub fn get_type_descriptor() -> &'static crate::ffi::HandleStandardType {
        unsafe { &*(crate::ffi::VrmlAPI_CafReader_get_type_descriptor()) }
    }
    ...
    pub fn as_rw_mesh_caf_reader_mut(&mut self) -> &mut crate::rw_mesh::CafReader {
        unsafe { &mut *(crate::ffi::VrmlAPI_CafReader_as_RWMesh_CafReader_mut(self as *mut Self)) }
    }
    ...
    pub fn as_standard_transient_mut(&mut self) -> &mut crate::standard::Transient {
        unsafe {
            &mut *(crate::ffi::VrmlAPI_CafReader_as_Standard_Transient_mut(self as *mut Self))
        }
    }
    ...
    pub fn to_handle(
        ...
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_CafReader_to_handle(obj.into_raw()))
        }
    }
    ...
    pub fn memory_limit_mi_b(&self) -> i32 {
        unsafe { crate::ffi::VrmlAPI_CafReader_inherited_MemoryLimitMiB(self as *const Self) }
    }
    ...
    pub fn system_length_unit(&self) -> f64 {
        unsafe { crate::ffi::VrmlAPI_CafReader_inherited_SystemLengthUnit(self as *const Self) }
    }
    ...
    pub fn file_length_unit(&self) -> f64 {
        unsafe { crate::ffi::VrmlAPI_CafReader_inherited_FileLengthUnit(self as *const Self) }
    }
    ...
    pub fn single_shape(&self) -> crate::OwnedPtr<crate::topo_ds::Shape> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_CafReader_inherited_SingleShape(
                self as *const Self,
            ))
        }
    }
    ...
    pub fn external_files(&self) -> &crate::ffi::Interface_IndexedMapOfAsciiString {
        unsafe { &*(crate::ffi::VrmlAPI_CafReader_inherited_ExternalFiles(self as *const Self)) }
    }
    ...
    pub fn is_instance(&self, theType: &crate::ffi::HandleStandardType) -> bool {
        unsafe { crate::ffi::VrmlAPI_CafReader_inherited_IsInstance(self as *const Self, theType) }
    }

    /// Inherited: **Source:** `Standard_Transient.hxx`:83 - `Standard_Transient::IsKind()`
    pub fn is_kind(&self, theType: &crate::ffi::HandleStandardType) -> bool {
        unsafe { crate::ffi::VrmlAPI_CafReader_inherited_IsKind(self as *const Self, theType) }
    }

    /// Inherited: **Source:** `Standard_Transient.hxx`:94 - `Standard_Transient::This()`
    pub fn this(&self) -> Option<&crate::standard::Transient> {
        {
            let ptr = unsafe { crate::ffi::VrmlAPI_CafReader_inherited_This(self as *const Self) };
            if ptr.is_null() {
                None
            } else {
                Some(unsafe { &*ptr })
    ...
    pub fn increment_ref_counter(&mut self) {
        unsafe { crate::ffi::VrmlAPI_CafReader_inherited_IncrementRefCounter(self as *mut Self) }
    }

    /// Inherited: **Source:** `Standard_Transient.hxx`:107 - `Standard_Transient::DecrementRefCounter()`
    pub fn decrement_ref_counter(&mut self) -> i32 {
        unsafe { crate::ffi::VrmlAPI_CafReader_inherited_DecrementRefCounter(self as *mut Self) }
    }
...
impl HandleVrmlAPICafReader {
    ...
    pub fn get(&self) -> &crate::ffi::VrmlAPI_CafReader {
        unsafe { &*(crate::ffi::HandleVrmlAPICafReader_get(self as *const Self)) }
    }
    ...
    pub fn get_mut(&mut self) -> &mut crate::ffi::VrmlAPI_CafReader {
        unsafe { &mut *(crate::ffi::HandleVrmlAPICafReader_get_mut(self as *mut Self)) }
    }
    ...
    pub fn to_handle_caf_reader(&self) -> crate::OwnedPtr<crate::ffi::HandleRWMeshCafReader> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::HandleVrmlAPICafReader_to_HandleRWMeshCafReader(
                self as *const Self,
            ))
        }
    }
...
impl Writer {
    ...
    pub fn new() -> crate::OwnedPtr<Self> {
        unsafe { crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_ctor()) }
    }
    ...
    pub fn reset_to_defaults(&mut self) {
        unsafe { crate::ffi::VrmlAPI_Writer_reset_to_defaults(self as *mut Self) }
    }
    ...
    pub fn drawer(&self) -> crate::OwnedPtr<crate::ffi::HandleVrmlConverterDrawer> {
        unsafe { crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_drawer(self as *const Self)) }
    }
    ...
    pub fn set_representation(&mut self, aRep: crate::vrml_api::RepresentationOfShape) {
        unsafe { crate::ffi::VrmlAPI_Writer_set_representation(self as *mut Self, aRep.into()) }
    }
    ...
    pub fn get_representation(&self) -> crate::vrml_api::RepresentationOfShape {
        unsafe {
            crate::vrml_api::RepresentationOfShape::try_from(
    ...
    pub fn get_front_material(&self) -> crate::OwnedPtr<crate::ffi::HandleVrmlMaterial> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_get_front_material(
                self as *const Self,
            ))
        }
    }
    ...
    pub fn get_points_material(&self) -> crate::OwnedPtr<crate::ffi::HandleVrmlMaterial> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_get_points_material(
                self as *const Self,
            ))
        }
    }
    ...
    pub fn get_uiso_material(&self) -> crate::OwnedPtr<crate::ffi::HandleVrmlMaterial> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_get_uiso_material(
                self as *const Self,
            ))
        }
    }
    ...
    pub fn get_viso_material(&self) -> crate::OwnedPtr<crate::ffi::HandleVrmlMaterial> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_get_viso_material(
                self as *const Self,
            ))
        }
    }
    ...
    pub fn get_line_material(&self) -> crate::OwnedPtr<crate::ffi::HandleVrmlMaterial> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_get_line_material(
                self as *const Self,
            ))
        }
    }
    ...
    pub fn get_wire_material(&self) -> crate::OwnedPtr<crate::ffi::HandleVrmlMaterial> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_get_wire_material(
                self as *const Self,
            ))
        }
    }
    ...
    pub fn get_free_bounds_material(&self) -> crate::OwnedPtr<crate::ffi::HandleVrmlMaterial> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_get_free_bounds_material(
                self as *const Self,
            ))
        }
    }
    ...
    pub fn get_unfree_bounds_material(&self) -> crate::OwnedPtr<crate::ffi::HandleVrmlMaterial> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::VrmlAPI_Writer_get_unfree_bounds_material(
                self as *const Self,
            ))
        }
    }
