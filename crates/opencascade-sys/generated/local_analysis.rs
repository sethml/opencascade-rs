...
impl CurveContinuity {
    ...
    pub fn new_handlegeomcurve_real_handlegeomcurve_real_shape_real8(
        ...
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::LocalAnalysis_CurveContinuity_ctor_handlegeomcurve_real_handlegeomcurve_real_shape_real8(Curv1, u1, Curv2, u2, Order.into(), EpsNul, EpsC0, EpsC1, EpsC2, EpsG1, EpsG2, Percent, Maxlen))
        }
    }
    ...
    pub fn status_error(&self) -> crate::local_analysis::StatusErrorType {
        unsafe {
            crate::local_analysis::StatusErrorType::try_from(
...
impl SurfaceContinuity {
    ...
    pub fn new_handlegeomsurface_real2_handlegeomsurface_real2_shape_real7(
        ...
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::LocalAnalysis_SurfaceContinuity_ctor_handlegeomsurface_real2_handlegeomsurface_real2_shape_real7(Surf1, u1, v1, Surf2, u2, v2, Order.into(), EpsNul, EpsC0, EpsC1, EpsC2, EpsG1, Percent, Maxlen))
        }
    }
    ...
    pub fn new_handlegeom2dcurve2_real_handlegeomsurface2_shape_real7(
        ...
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::LocalAnalysis_SurfaceContinuity_ctor_handlegeom2dcurve2_real_handlegeomsurface2_shape_real7(curv1, curv2, U, Surf1, Surf2, Order.into(), EpsNul, EpsC0, EpsC1, EpsC2, EpsG1, Percent, Maxlen))
        }
    }
    ...
    pub fn new_real7(
        ...
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::LocalAnalysis_SurfaceContinuity_ctor_real7(
    ...
    pub fn g2_curvature_gap(&self) -> f64 {
        unsafe { crate::ffi::LocalAnalysis_SurfaceContinuity_g2_curvature_gap(self as *const Self) }
    }
