...
pub(crate) mod ffi {
    unsafe extern "C++" {
        ...
        #[doc = "<me> = theMatrix * <me>"]
        #[cxx_name = "Multiply"]
        fn multiply_mat(self: Pin<&mut XYZ>, theMatrix: &gp_Mat);
        ...
        #[cxx_name = "gp_XYZ_Multiplied"]
        fn XYZ_multiplied_mat(self_: &XYZ, theMatrix: &gp_Mat) -> UniquePtr<XYZ>;
        ...
        #[cxx_name = "SetRotation"]
        fn set_rotation_quaternion(self: Pin<&mut Trsf>, theR: &gp_Quaternion);
        ...
        #[cxx_name = "SetTransformation"]
        fn set_transformation_quaternion_vec(self: Pin<&mut Trsf>, R: &gp_Quaternion, theT: &Vec_);
        ...
        #[cxx_name = "Transforms"]
        fn transforms_xy(self: &Trsf2d, theCoord: Pin<&mut gp_XY>);
        ...
        #[cxx_name = "Transforms"]
        fn transforms_xy(self: &GTrsf2d, theCoord: Pin<&mut gp_XY>);
...
impl XYZ {
    ...
    #[doc = "New = theMatrix * <me>"]
    pub fn multiplied_mat(&self, theMatrix: &ffi::gp_Mat) -> cxx::UniquePtr<ffi::XYZ> {
...
impl Trsf {
    ...
    #[doc = "Returns the nature of the transformation. It can be: an identity transformation, a rotation, a translation, a mirror transformation (relative to a point, an axis or a plane), a scaling transformation, or a compound transformation."]
    pub fn form(&self) -> cxx::UniquePtr<ffi::gp_TrsfForm> {
        ffi::Trsf_form(self)
    }

    #[doc = "Returns quaternion representing rotational part of the transformation."]
    pub fn get_rotation(&self) -> cxx::UniquePtr<ffi::gp_Quaternion> {
        ffi::Trsf_get_rotation(self)
    }

    #[doc = "Returns the vectorial part of the transformation. It is a 3*3 matrix which includes the scale factor."]
    pub fn vectorial_part(&self) -> cxx::UniquePtr<ffi::gp_Mat> {
...
impl Trsf2d {
    ...
    #[doc = "Returns the nature of the transformation. It can be  an identity transformation, a rotation, a translation, a mirror (relative to a point or an axis), a scaling transformation, or a compound transformation."]
    pub fn form(&self) -> cxx::UniquePtr<ffi::gp_TrsfForm> {
        ffi::Trsf2d_form(self)
    }

    #[doc = "Returns the vectorial part of the transformation. It is a 2*2 matrix which includes the scale factor."]
    pub fn vectorial_part(&self) -> cxx::UniquePtr<ffi::gp_Mat2d> {
...
impl GTrsf2d {
    ...
    pub fn transformed(&self, theCoord: &ffi::gp_XY) -> cxx::UniquePtr<ffi::gp_XY> {
