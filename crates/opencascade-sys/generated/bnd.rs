...
impl BoundSortBox {
    ...
    pub fn initialize(&mut self, CompleteBox: &crate::ffi::Bnd_Box, nbComponents: i32) {
        unsafe {
            crate::ffi::Bnd_BoundSortBox_initialize(self as *mut Self, CompleteBox, nbComponents)
        }
    }
