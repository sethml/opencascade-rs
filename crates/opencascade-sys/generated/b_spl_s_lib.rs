...
impl Cache {
    ...
    pub fn as_standard_transient_mut(&mut self) -> &mut crate::standard::Transient {
        unsafe { &mut *(crate::ffi::BSplSLib_Cache_as_Standard_Transient_mut(self as *mut Self)) }
    }
    ...
    pub fn is_instance(&self, theType: &crate::ffi::HandleStandardType) -> bool {
        unsafe { crate::ffi::BSplSLib_Cache_inherited_IsInstance(self as *const Self, theType) }
    }

    /// Inherited: **Source:** `Standard_Transient.hxx`:83 - `Standard_Transient::IsKind()`
    pub fn is_kind(&self, theType: &crate::ffi::HandleStandardType) -> bool {
        unsafe { crate::ffi::BSplSLib_Cache_inherited_IsKind(self as *const Self, theType) }
    }
    ...
    pub fn decrement_ref_counter(&mut self) -> i32 {
        unsafe { crate::ffi::BSplSLib_Cache_inherited_DecrementRefCounter(self as *mut Self) }
    }
...
impl HandleBSplSLibCache {
    ...
    pub fn to_handle_transient(&self) -> crate::OwnedPtr<crate::ffi::HandleStandardTransient> {
        unsafe {
            crate::OwnedPtr::from_raw(crate::ffi::HandleBSplSLibCache_to_HandleStandardTransient(
                self as *const Self,
            ))
        }
    }
...
// SKIPPED: **Source:** `BSplSLib_EvaluatorFunction.hxx`:35 - `BSplSLib_EvaluatorFunction::BSplSLib_EvaluatorFunction`
//   constructor: Empty constructor
//   Reason: class is abstract (has unimplemented pure virtual methods)
//   // pub fn new() -> OwnedPtr<Self>;
//
// SKIPPED: **Source:** `BSplSLib_EvaluatorFunction.hxx`:41 - `BSplSLib_EvaluatorFunction::Evaluate`
//   method: Function evaluation method to be defined by descendant
//   Reason: has misresolved element type (clang batch parsing artifact)
//   // pub fn evaluate(&self, theDerivativeRequest: i32, theUParameter: f64, theVParameter: f64, theResult: &mut f64, theErrorCode: &mut i32);
//
