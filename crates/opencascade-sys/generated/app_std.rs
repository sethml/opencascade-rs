...
impl Application {
    ...
    pub fn as_t_doc_std_application(&self) -> &crate::t_doc_std::Application {
        {
            let __result = unsafe {
                crate::ffi::AppStd_Application_as_TDocStd_Application(self as *const Self)
            };
            crate::check_exception();
            unsafe { &*__result }
        }
    ...
    pub fn as_t_doc_std_application_mut(&mut self) -> &mut crate::t_doc_std::Application {
        {
            let __result = unsafe {
                crate::ffi::AppStd_Application_as_TDocStd_Application_mut(self as *mut Self)
            };
            crate::check_exception();
            unsafe { &mut *__result }
        }
    ...
    pub fn as_standard_transient(&self) -> &crate::standard::Transient {
        {
            let __result = unsafe {
                crate::ffi::AppStd_Application_as_Standard_Transient(self as *const Self)
            };
            crate::check_exception();
            unsafe { &*__result }
        }
    ...
    pub fn as_standard_transient_mut(&mut self) -> &mut crate::standard::Transient {
        {
            let __result = unsafe {
                crate::ffi::AppStd_Application_as_Standard_Transient_mut(self as *mut Self)
            };
            crate::check_exception();
            unsafe { &mut *__result }
        }
...
impl HandleAppStdApplication {
    ...
    pub fn get_mut(&mut self) -> &mut crate::ffi::AppStd_Application {
        {
            let __result =
                unsafe { crate::ffi::HandleAppStdApplication_get_mut(self as *mut Self) };
            crate::check_exception();
            unsafe { &mut *__result }
        }
    }
