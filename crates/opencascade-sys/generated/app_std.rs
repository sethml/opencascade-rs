...
impl Application {
    ...
    pub fn new() -> crate::OwnedPtr<Self> {
        {
            let __result = unsafe { crate::ffi::AppStd_Application_ctor() };
    ...
    pub fn resources_name(&mut self) -> std::string::String {
        {
            let __result =
                unsafe { crate::ffi::AppStd_Application_resources_name(self as *mut Self) };
            if !__result.exc.is_null() {
                crate::wrapper_threw_exception(__result.exc);
            }
    ...
    pub fn get_type_name() -> std::string::String {
        {
            let __result = unsafe { crate::ffi::AppStd_Application_get_type_name() };
            if !__result.exc.is_null() {
                crate::wrapper_threw_exception(__result.exc);
            }
            let __val = __result.ret;
    ...
    pub fn get_type_descriptor() -> &'static crate::ffi::HandleStandardType {
        {
            let __result = unsafe { crate::ffi::AppStd_Application_get_type_descriptor() };
            if !__result.exc.is_null() {
                crate::wrapper_threw_exception(__result.exc);
            }
            let __val = __result.ret;
    ...
    pub fn as_t_doc_std_application_mut(&mut self) -> &mut crate::t_doc_std::Application {
        let __result =
            unsafe { crate::ffi::AppStd_Application_as_TDocStd_Application_mut(self as *mut Self) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
    ...
    pub fn as_cdf_application_mut(&mut self) -> &mut crate::cdf::Application {
        let __result =
            unsafe { crate::ffi::AppStd_Application_as_CDF_Application_mut(self as *mut Self) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { &mut *__result.ret }
    ...
    pub fn as_cdm_application_mut(&mut self) -> &mut crate::cdm::Application {
        let __result =
            unsafe { crate::ffi::AppStd_Application_as_CDM_Application_mut(self as *mut Self) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { &mut *__result.ret }
    ...
    pub fn as_standard_transient_mut(&mut self) -> &mut crate::standard::Transient {
        let __result =
            unsafe { crate::ffi::AppStd_Application_as_Standard_Transient_mut(self as *mut Self) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { &mut *__result.ret }
    ...
    pub fn to_handle(
        ...
        let __result = unsafe { crate::ffi::AppStd_Application_to_handle(obj.into_raw()) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { crate::OwnedPtr::from_raw(__result.ret) }
    ...
    pub fn resources(&mut self) -> crate::OwnedPtr<crate::ffi::HandleResourceManager> {
        {
            let __result =
                unsafe { crate::ffi::AppStd_Application_inherited_Resources(self as *mut Self) };
            if !__result.exc.is_null() {
                crate::wrapper_threw_exception(__result.exc);
            }
            let __val = __result.ret;
    ...
    pub fn reading_formats(&mut self, theFormats: &mut crate::ffi::TColStd_SequenceOfAsciiString) {
        {
            let __exc = unsafe {
                crate::ffi::AppStd_Application_inherited_ReadingFormats(
                    self as *mut Self,
                    theFormats,
                )
            };
    ...
    pub fn writing_formats(&mut self, theFormats: &mut crate::ffi::TColStd_SequenceOfAsciiString) {
        {
            let __exc = unsafe {
                crate::ffi::AppStd_Application_inherited_WritingFormats(
                    self as *mut Self,
                    theFormats,
                )
            };
    ...
    pub fn get_document(&self, index: i32, aDoc: &mut crate::ffi::HandleTDocStdDocument) {
        {
            let __exc = unsafe {
                crate::ffi::AppStd_Application_inherited_GetDocument(
                    self as *const Self,
                    index,
                    aDoc,
                )
    ...
    pub fn new_document(
        ...
        {
            let __exc = unsafe {
                crate::ffi::AppStd_Application_inherited_NewDocument(
                    self as *mut Self,
                    format,
                    aDoc,
                )
    ...
    pub fn on_open_transaction(&mut self, theDoc: &crate::ffi::HandleTDocStdDocument) {
        {
            let __exc = unsafe {
                crate::ffi::AppStd_Application_inherited_OnOpenTransaction(
                    self as *mut Self,
                    theDoc,
                )
            };
    ...
    pub fn on_commit_transaction(&mut self, theDoc: &crate::ffi::HandleTDocStdDocument) {
        {
            let __exc = unsafe {
                crate::ffi::AppStd_Application_inherited_OnCommitTransaction(
                    self as *mut Self,
                    theDoc,
                )
            };
    ...
    pub fn on_abort_transaction(&mut self, theDoc: &crate::ffi::HandleTDocStdDocument) {
        {
            let __exc = unsafe {
                crate::ffi::AppStd_Application_inherited_OnAbortTransaction(
                    self as *mut Self,
                    theDoc,
                )
            };
    ...
    pub fn format(
        ...
        {
            let __result = unsafe {
                crate::ffi::AppStd_Application_inherited_Format(
                    self as *mut Self,
                    aFileName,
                    theFormat,
                )
    ...
    pub fn name(&self) -> crate::OwnedPtr<crate::t_collection::ExtendedString> {
        {
            let __result =
                unsafe { crate::ffi::AppStd_Application_inherited_Name(self as *const Self) };
            if !__result.exc.is_null() {
                crate::wrapper_threw_exception(__result.exc);
            }
            let __val = __result.ret;
    ...
    pub fn version(&self) -> crate::OwnedPtr<crate::t_collection::AsciiString> {
        {
            let __result =
                unsafe { crate::ffi::AppStd_Application_inherited_Version(self as *const Self) };
            if !__result.exc.is_null() {
                crate::wrapper_threw_exception(__result.exc);
            }
            let __val = __result.ret;
    ...
    pub fn this(&self) -> Option<&crate::standard::Transient> {
        {
            let __result =
                unsafe { crate::ffi::AppStd_Application_inherited_This(self as *const Self) };
            if !__result.exc.is_null() {
                crate::wrapper_threw_exception(__result.exc);
            }
            let __val = __result.ret;
...
impl HandleAppStdApplication {
    ...
    pub fn get(&self) -> &crate::ffi::AppStd_Application {
        let __result = unsafe { crate::ffi::HandleAppStdApplication_get(self as *const Self) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { &*__result.ret }
    ...
    pub fn get_mut(&mut self) -> &mut crate::ffi::AppStd_Application {
        let __result = unsafe { crate::ffi::HandleAppStdApplication_get_mut(self as *mut Self) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { &mut *__result.ret }
    ...
    pub fn to_handle_t_doc_std_application(
        ...
        let __result = unsafe {
            crate::ffi::HandleAppStdApplication_to_HandleTDocStdApplication(self as *const Self)
        };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
