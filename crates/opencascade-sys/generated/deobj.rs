...
// SKIPPED: **Source:** `DEOBJ_ConfigurationNode.hxx`:39 - `DEOBJ_ConfigurationNode::DEOBJ_ConfigurationNode`
...
//   // pub fn new_handledeobjconfigurationnode(theNode: &HandleConfigurationNode) -> OwnedPtr<Self>;
//
...
impl Provider {
    ...
    pub fn read(
        ...
        unsafe {
            crate::ffi::DEOBJ_Provider_read(self as *mut Self, thePath, theShape, theProgress)
        }
    }
    ...
    pub fn write(
        ...
        unsafe {
            crate::ffi::DEOBJ_Provider_write(self as *mut Self, thePath, theShape, theProgress)
        }
    }
...
//
// SKIPPED: **Source:** `DEOBJ_Provider.hxx`:93 - `DEOBJ_Provider::Read`
//   method: Reads a CAD file, according internal configuration
//   method: @param[in] thePath path to the import CAD file
...
//
// SKIPPED: **Source:** `DEOBJ_Provider.hxx`:105 - `DEOBJ_Provider::Write`
//   method: Writes a CAD file, according internal configuration
//   method: @param[in] thePath path to the export CAD file
