...
impl TestInterference {
    ...
    pub fn new() -> crate::OwnedPtr<Self> {
        unsafe { crate::OwnedPtr::from_raw(crate::ffi::TopBas_TestInterference_ctor()) }
    }
    ...
    pub fn change_intersection(&mut self) -> &mut f64 {
        unsafe {
            &mut *(crate::ffi::TopBas_TestInterference_change_intersection(self as *mut Self))
        }
    }
    ...
    pub fn change_boundary(&mut self) -> &mut i32 {
        unsafe { &mut *(crate::ffi::TopBas_TestInterference_change_boundary(self as *mut Self)) }
    }
    ...
    pub fn orientation(&self) -> crate::top_abs::Orientation {
        unsafe {
            crate::top_abs::Orientation::try_from(crate::ffi::TopBas_TestInterference_orientation(
                self as *const Self,
            ))
            .unwrap()
        }
    ...
    pub fn transition(&self) -> crate::top_abs::Orientation {
        unsafe {
            crate::top_abs::Orientation::try_from(crate::ffi::TopBas_TestInterference_transition(
                self as *const Self,
            ))
            .unwrap()
        }
