...
impl ConfigurationNode {
    ...
    pub fn to_handle(
        ...
        let __result = unsafe { crate::ffi::DESTEP_ConfigurationNode_to_handle(obj.into_raw()) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { crate::OwnedPtr::from_raw(__result.ret) }
...
impl Parameters {
    ...
    pub fn reset(&mut self) {
        {
            let __exc = unsafe { crate::ffi::DESTEP_Parameters_reset(self as *mut Self) };
            if !__exc.is_null() {
                crate::wrapper_threw_exception(__exc);
            }
        }
...
impl Provider {
    ...
    pub fn as_de_provider(&self) -> &crate::de::Provider {
        let __result = unsafe { crate::ffi::DESTEP_Provider_as_DE_Provider(self as *const Self) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { &*__result.ret }
    ...
    pub fn as_de_provider_mut(&mut self) -> &mut crate::de::Provider {
        let __result = unsafe { crate::ffi::DESTEP_Provider_as_DE_Provider_mut(self as *mut Self) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { &mut *__result.ret }
...
impl HandleDESTEPProvider {
    ...
    pub fn to_handle_provider(&self) -> crate::OwnedPtr<crate::ffi::HandleDEProvider> {
        let __result =
            unsafe { crate::ffi::HandleDESTEPProvider_to_HandleDEProvider(self as *const Self) };
        if !__result.exc.is_null() {
            crate::wrapper_threw_exception(__result.exc);
        }
        unsafe { crate::OwnedPtr::from_raw(__result.ret) }
