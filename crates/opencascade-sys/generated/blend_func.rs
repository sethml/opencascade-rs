...
impl ConstThroat {
    ...
    pub fn nb_intervals(&self, S: crate::geom_abs::Shape) -> i32 {
        {
            let __result = unsafe {
                crate::ffi::BlendFunc_ConstThroat_inherited_NbIntervals(
                    self as *const Self,
                    S.into(),
                )
            };
...
impl ConstThroatWithPenetration {
    ...
    pub fn derivatives(
        ...
        {
            let __result = unsafe {
                crate::ffi::BlendFunc_ConstThroatWithPenetration_derivatives(
                    self as *mut Self,
                    X,
                    D,
                )
    ...
    pub fn get_section_size(&self) -> f64 {
        {
            let __result = unsafe {
                crate::ffi::BlendFunc_ConstThroatWithPenetration_get_section_size(
                    self as *const Self,
                )
            };
            if !__result.exc.is_null() {
...
impl ConstThroatWithPenetrationInv {
    ...
    pub fn derivatives(
        ...
        {
            let __result = unsafe {
                crate::ffi::BlendFunc_ConstThroatWithPenetrationInv_derivatives(
                    self as *mut Self,
                    X,
                    D,
                )
