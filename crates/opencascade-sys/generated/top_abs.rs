...
impl TopAbs {
    ...
    pub fn compose(Or1: i32, Or2: i32) -> i32 {
        crate::ffi::TopAbs_compose(Or1, Or2)
    }
    ...
    pub fn reverse(Or: i32) -> i32 {
        crate::ffi::TopAbs_reverse(Or)
    }
    ...
    /// becomes outside.
    pub fn complement(Or: i32) -> i32 {
        crate::ffi::TopAbs_complement(Or)
    }
    ...
    pub fn shape_type_from_string(theTypeString: &str) -> i32 {
        crate::ffi::TopAbs_shape_type_from_string(theTypeString)
    }
    ...
    pub fn shape_orientation_from_string(theOrientationString: &str) -> i32 {
        crate::ffi::TopAbs_shape_orientation_from_string(theOrientationString)
    }
}
