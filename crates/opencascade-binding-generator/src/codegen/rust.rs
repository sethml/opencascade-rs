...
pub fn generate_module(
    ...
    let type_ctx = TypeContext {
        ...
        handle_able_classes: None,  // Per-module mode doesn't need this - uses separate ffi files
    };
...
// =============================================================================
// UNIFIED FFI MODULE GENERATION (Step 4i)
// =============================================================================
//
...
/// Information about a class for unified generation
...
/// Generate a single method for unified mode (no suffix)
