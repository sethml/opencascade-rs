...
pub fn generate_module_header(
    ...
    global_inheritance_map: &std::collections::HashMap<String, Vec<String>>,
    ...
    for class in classes {
        generate_class_wrappers(class, &mut output, all_enum_names, all_class_names, global_inheritance_map);
    }

    // Generate wrappers for namespace-level free functions
    generate_function_wrappers(&module.name, functions, &mut output, all_enum_names, all_class_names, known_headers);
...
fn generate_class_wrappers(class: &ParsedClass, output: &mut String, all_enum_names: &HashSet<String>, all_class_names: &HashSet<String>, inheritance_map: &std::collections::HashMap<String, Vec<String>>) {
    writeln!(output, "// ========================").unwrap();
    ...
    generate_constructor_wrappers(class, output, all_enum_names);
    ...
    generate_c_string_return_wrappers(class, output, all_enum_names);
    ...
    generate_upcast_wrappers(class, output, all_class_names, inheritance_map);
    ...
    generate_handle_upcast_wrappers(class, output, all_class_names, inheritance_map);
...
fn generate_upcast_wrappers(class: &ParsedClass, output: &mut String, all_class_names: &HashSet<String>, inheritance_map: &std::collections::HashMap<String, Vec<String>>) {
    // Get all ancestors for this class
    let empty_vec = Vec::new();
    let ancestors = inheritance_map.get(&class.name).unwrap_or(&empty_vec);
...
fn generate_handle_upcast_wrappers(class: &ParsedClass, output: &mut String, all_class_names: &HashSet<String>, inheritance_map: &std::collections::HashMap<String, Vec<String>>) {
...
fn generate_function_wrappers(
    ...
    for func in functions {
        ...
        if method_uses_enum(&func.params, &func.return_type, all_enum_names) {
            continue;
        }
